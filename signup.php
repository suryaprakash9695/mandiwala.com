    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <div class="login">
                ...
                <h3 class="title" style="margin-left: 100px; color: tomato;" >Farmer SignUp</h3>
                <form id="form" action="signupcontroller.php" method="post">
                    ...
                    <div class="text-input">
                        ...
                        <input type="text" required="required" name="gender" placeholder="Gender">
                    </div>
                    <div class="text-input">
                    ...
                    <div class="text-input">
                        ...
                        <input type="number" required="required" name="contactno" placeholder="Contact Number">
                    </div>
                    <div class="text-input">

                        <input type="number" required="required" name="pincode" placeholder="Pincode">
                    </div>
                    <div class="text-input">
                ...
                <div class="create"style="margin-top: 60px; margin-left: 300px;">
                        <a href="login.php" style="color: tomato;" >Login Here</a>
                    </div>
