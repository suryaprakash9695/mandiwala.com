...
<body>
    <div class="container-fluid">
        ...
        background: linear-gradient(90deg, rgba(189,61,242,1) 7%, rgba(5,169,221,1) 47%, rgba(241,148,107,1) 100%);">
            <h1 style="margin: auto; text-align: center;">Signedin Persons</h1>
        </div>
        <div class="row mt-5" style="height: 100%; background-color:antiquewhite;background: rgb(189,61,242);
        background: linear-gradient(90deg, rgba(189,61,242,1) 7%, rgba(5,169,221,1) 47%, rgba(241,148,107,1) 100%);">
            <div>
                <table style="width:100%; border-collapse: collapse; font-size: 25px;border-color: #96D4D4; border: 1px solid black;" table="table border">
                    ...
                    ?>
                        <tr style="border: 1px solid black;">
                        <td style="border: 1px solid black;"><?php echo $res['username'] ?></td>

                            <td style="border: 1px solid black;"><?php echo $res['name'] ?></td>
                            <td style="border: 1px solid black;"><?php echo $res['gender'] ?></td>
                            <td style="border: 1px solid black;"><?php echo $res['email'] ?></td>
                            <td style="border: 1px solid black;"><?php echo $res['password'] ?></td>

                            <td style="border: 1px solid black;"><?php echo $res['contactno'] ?></td>
                            <td style="border: 1px solid black;"><?php echo $res['pincode'] ?></td>
                            <td style="border: 1px solid black;"><?php echo $res['address'] ?></td>
