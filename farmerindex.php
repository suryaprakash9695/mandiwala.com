...
<body>
    <div class="container-fluid">
                ...
                <div class="container-fluid" style="width: 100%; ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto  mb-lg-0">
                            ...
                            <li class="nav-item" style="margin-left: 20px;">
                                <a class="nav-link active" aria-current="page" href="farmerindex.php" style="font-size: 30px;">FARMER DASHBOARD</a>
                            </li>
                            <li class="nav-item mt-2" style="margin-left: 35px; font-size: 20px; margin-left: 500px;">
                                <a class="nav-link" href="addeditems.php"> <i class="fa-solid fa-cart-arrow-down mx-1"></i>Added Items</a>
                            </li>
        ...
        <!--items starts-->
        <?php include('template/fitems.php'); ?>
        <!-- items ends-->
